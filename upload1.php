...
<div class="login-box">
<form name="form" method="post" action="upload1.php" enctype="multipart/form-data" >
...
// Where the file is going to be stored
 ...
 echo"<br><center><img src='upload/input1/input.jpg' height=250 width=300></center>";

}
?>
<br></br><form name="f1" method="post" action="action1.php" enctype="multipart/form-data" >
