...
// Where the file is going to be stored
 ...
 echo"<br><center><img src='upload/input/input.jpg' height=250 width=300></center>";

}
?>
<br></br><form name="f1" method="post" action="action.php" enctype="multipart/form-data" >
